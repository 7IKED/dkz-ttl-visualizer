...
![Lines](https://img.shields.io/badge/Lines-505-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-ttl-visualizer.git

# Oeffnen
cd dkz-ttl-visualizer
